...
The table `flights` in the package contains all 336,776 flights that departed from New York City in 2013. The data comes from the US Bureau of Transportation Statistics, and is documented in `?flights` 
...
In the SQL code below, we can see one difference in how the code is written—it runs "inside out", rather than in the linear manner we are accustomed to in our R pipes.
