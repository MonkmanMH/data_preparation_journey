...
Once this has been done, our R Markdown document can incorporate native SQL queries into the workflow. Note that in our SQL chunk, we specify the connection. A we continue to work through this example, this is the `con_nycf` object created earlier.
