...
Earlier in \@ref(foundations) [foundations], challenges associated with "dirty data" were introduced. 
...
The "badpenguins.rds" file adds five fictional penguins to the "penguins" table, including measurement data. Let's load the data file "badpenguins.rds" (an R data file) and run a couple of the tests we used earlier:
