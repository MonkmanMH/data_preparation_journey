...
For this example, we will use some mock data that is the type a data analyst might encounter when undertaking analysis of a human resource data to support business decision-making. 

> add "what proportion of staff could potentially retire in the next three years?" example
