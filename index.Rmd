...
Welcome to _The Data Preparation Journey: Finding Your Way With R_, a forthcoming book published with CRC Press as part of [The R Series](https://www.routledge.com/go/the-r-series/).
...
In _Exploratory Data Analysis_, Tukey writes "the analyst of data needs both tools and understanding. The purpose of this book is to provide some of each." [@Tukey_1977, p.1] It is my hope that this book accomplishes the same.
...
**Chapter 3: Data documentation** 

* Creating documentation, including data dictionaries and literate programming


**SECTION B: IMPORTING DATA**

**Chapter 4: Importing data**

* Principles for importing data, no matter the format

**Chapter 5: Importing data: plain-text files**

* Getting data in a variety of formats, including CSV and fixed-width text files

**Chapter 6: Importing data: Excel**

* Getting data from Excel files

* Extracting data stored as formats

**Chapter 7: Importing data: statistical software**

* Capturing data and value labels from statistical software formats such as SPSS, Stata, and SAS

**Chapter 8: Data from PDF files**

* Getting data out of a PDF file, whether quantitative or qualitative (text)


**Chapter 9: Data from web sources**

* Acquiring data using R packages that leverage web APIs


**Chapter 10: Linking to relational databases** 

* Accessing data directly from databases
...
**Chapter 11: Validation strategies**

* Exploratory data analysis to identify problems

* Using structured testing to validate data


**Chapter 12: Cleaning techniques**

* Cleaning dates and strings

* Creating conditional and calculated variables, including indicator variables
...
I would like to acknowledge everyone who has contributed to the books, articles, blog posts, and R packages cited within. As well, thanks to my former colleagues at BC Stats, my current colleagues at MNP, and my colleagues and students at the University of Victoria's Business Intelligence & Data Analytics program. The enthusiasm of this community of people I know well and people around the world I have never met has helped sustain my own interest, and without it I wouldn't have written this book.
