...
* Column headers are values instead of variable names. A frequently-encountered example are units of time, as in the example below, showing the population of Canada and the United States in 1952 and 2007:
...
These tables are also constrained in that they can only display one variable; in this case, it is the population of the country.
