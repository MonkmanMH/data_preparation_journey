...
The database may have historical data, containing the records associated with people who no longer work with the organization. With that information, you would be able to build a model to predict when people might resign or retire, based on various demographic and occupational characteristics.
