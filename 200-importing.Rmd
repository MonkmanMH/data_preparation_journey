...
> "Use the arguments of your import function to get as far as you can, as fast as possible."—Jenny Bryan^[@Bryan_STAT545, [Chapter 9: Writing and reading files](https://stat545.com/import-export.html)]
...
The {readr} [@R-readr] package is part of the tidyverse, and has some advantages over the base R functions to read plain-text files.
