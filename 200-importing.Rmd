...
## Spreadsheets (starting with Excel)
...
Excel files (with either the .XLS or .XLSX extensions) are widely used, and it seems likely they are more common than CSV and other plain-text data files. Excel files seem to multiply like coat hangers in the closet.

As we see in the article by Karl Broman & Kara Woo, ["Data Organization in Spreadsheets"] [@Broman_Woo_2017], Excel files can encourage some ways of storing information that makes it hard for us to analyze. Excel files can also contain a wide variety of data format types. 
