...
It's also essential if you intend to share your data [@White_etal_nine_simple_ways]. The documentation we creates provides metadata (which we will see more of in the data dictionary section below), 
