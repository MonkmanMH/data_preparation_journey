...
To get started in reading data from a PDF file, we will read data from a summary of the {palmerpenguins}[@R-palmerpenguins] data. 
...
![_penguin data from PDF file_](img/penguin_pdf_1.PNG)
...
The next step is to build a table, using a for-loop. (See [@Wickham_Grolemund2016, Chapter 21 Iteration] for a review of this process.)
...
![_BC Ferries title page from PDF file_](img/bcferries_pdf_01.PNG)
...
![_BC Ferries page 11 from PDF file_](img/bcferries_pdf_p11.PNG)
...
![_BC Ferries page 12 from PDF file_](img/bcferries_pdf_p12.PNG)
...
![_BC Ferries: single line_](img/bcferries_pdf_1-13.PNG)
...
![_BC Ferries: remove commas_](img/bcferries_str_remove_1.PNG)
...
![_BC Ferries: table 2_](img/bcferries_table_2.PNG)
...
![_BC Ferries: table 3_](img/bcferries_table_3.PNG)
...
![_BC Ferries: table 3, final_](img/bcferries_table_3_final.PNG)
