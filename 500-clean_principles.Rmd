...
* Inconsistency in how values are recorded (all-too common is finding that dates are stored as both "2017-07-01" and "July 1, 2017").
...
* Logical inconsistency between variables (for example, union dues deducted from a non-union staff member)
...
One way to identify dirty data is through the process of _exploratory data analysis_ (EDA). [@Tukey_1977] 

This consists of two groups of techniques:
