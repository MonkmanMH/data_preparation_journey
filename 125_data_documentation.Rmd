...
All of the details involved with creating a reproducible workflow is outside the scope of this book; here we will concern ourselves with documentation.  
...
Marwick, Boettinger & Mullen provide some concrete examples of that a file structure might look like; note that the structure explicitly follows that of an R package. Their figure showing a "medium compendium" is below [@Marwick_etal_2018, p.84]:
