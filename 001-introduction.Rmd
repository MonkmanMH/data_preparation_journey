...
The generalist data scientist has a hand in all the steps through this workflow [@Monkman_bird_2019]; in this book we will focus on the Import to Tidy to Transform steps, an in-depth look at the process of getting data ready for analysis, sharing, and publication.
