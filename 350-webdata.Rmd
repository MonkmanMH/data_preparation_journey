...
In this section, we will explore an example that allows access to the data repository hosted by Statistics Canada. There are many other tools available; some are listed at the end of this chapter.
